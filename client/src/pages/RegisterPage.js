          ...
          <div className="bg-white rounded-3xl p-8 max-w-md w-full animate-fade-in transform transition-all duration-500 scale-100 shadow-2xl">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6">
                Your account has been created correctly. To access the system,
          ...
          <div className="relative z-10 h-full flex flex-col">
            ...
            <div className="mb-8 animate-slide-in-left">
              ...
              <p className="text-lg text-white/80 leading-relaxed">
                Create your account in minutes and unlock a world of secure
                banking features.
              </p>
            </div>
        ...
        <div className="lg:w-3/5 p-8 md:p-12 flex items-center justify-center">
          <div className="max-w-md w-full">
            ...
            <form
              ...
              className="animate-slide-in-right animation-delay-400 space-y-6"
            >
              {/* Name Fields */}
